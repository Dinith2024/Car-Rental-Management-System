...
if($lastInsertId)
{
 ...
 echo "<script>window.location.href ='addcar-rentpoint.php'</script>";
}
else 
{
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Add Rental Point </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
  	       <h3>Add Rental Point</h3>

  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Car Rent Point Name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="washingpointname" id="washingpointname" placeholder="Rental Point Name" required>
									</div>
								</div>
<div class="form-group">
