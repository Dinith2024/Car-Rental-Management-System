...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage Completed Rentals</li>
            </ol>
...
if($ptype==1): echo "Basic Rental ($119.99)";endif;
if($ptype==2): echo "Standard Rental ($499.99)";endif;
if($ptype==3): echo "Premium Rental ($999.99)";endif;
