...
$query->execute();
 ...
 echo "<script>window.location.href ='managecar-rentpoints.php'</script>";
}
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Edit rental Point </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
